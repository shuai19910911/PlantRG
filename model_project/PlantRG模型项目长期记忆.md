...
- 2026-06-04 已完成 PlantRG FASTA 数据审计，CDS/protein 各 1,605,489 条记录，ID 配对完整。
- 2026-06-04 已完成 protein 正样本严格清洗，剥离末端 `*` 后保留 1,583,910 条，保留率 98.6559%。
- 第一版主线应继续以 protein 作为模型输入，CDS 作为补充分析。
- 下一关键步骤是确认亚类标签可用性、构建负样本、同源去冗余和跨物种划分。
